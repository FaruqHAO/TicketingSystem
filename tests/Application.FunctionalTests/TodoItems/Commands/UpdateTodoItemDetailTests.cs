using TicketingSystem.Application.TodoItems.Commands.CreateTodoItem;
using TicketingSystem.Application.TodoItems.Commands.UpdateTodoItem;
using TicketingSystem.Application.TodoItems.Commands.UpdateTodoItemDetail;
using TicketingSystem.Application.TodoLists.Commands.CreateTodoList;
using TicketingSystem.Domain.Entities;
using TicketingSystem.Domain.Enums;

namespace TicketingSystem.Application.FunctionalTests.TodoItems.Commands;
