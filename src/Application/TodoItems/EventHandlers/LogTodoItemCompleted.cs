...
namespace TicketingSystem.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("TicketingSystem Domain Event: {DomainEvent}", notification.GetType().Name);
