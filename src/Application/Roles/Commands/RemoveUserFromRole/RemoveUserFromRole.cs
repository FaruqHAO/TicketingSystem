...
public class RemoveUserFromRoleCommandHandler : IRequestHandler<RemoveUserFromRoleCommand>
{
    ...
    public RemoveUserFromRoleCommandHandler(IRoleService roleService, IAuditService auditService)
    {
    ...
    {
        var result = await _roleService.RemoveUserFromRoleAsync(request.UserId, request.Role, cancellationToken);

        await _auditService.RecordAsync(
            AuthAuditAction.RoleRemoved,
            result.Succeeded,
